      ...
      <div className="row">
        <div className="col-lg-8 col-md-10 mx-auto">
          <div>
            ...
            <br />
            <div>
              Научный редактор – к.&thinsp;ю.&thinsp;н. Каменецкий Юрий
              Францевич
            </div>
            <div>
              Science editor – Candidate of Juridical Sciences (PhD in Law)
              Yuriy F. Kamenetskiy
            </div>
            <br />
            ...
            <div>
              ...
              информации № 1838 от 12.01.2017, выданное Министерством информации
              Республики Беларусь.
            </div>
            <br />
          </div>
